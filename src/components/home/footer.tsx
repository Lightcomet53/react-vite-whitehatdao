import { IconBrandDiscord, IconBrandGithub, IconBrandLinkedin, IconBrandTelegram, IconBrandTwitter } from "@tabler/icons-react";
            ...
            <ContainerBig className="lg:border-x border-borderColor py-8">
                <div className="lg:flex">
                    ...
                    <div className="w-[91.4vw] lg:w-[66vw]">
                        <p className="text-white mb-10 lg:w-1/2">We want to make it easy for everyone to embrace the web3 ecosystem in a secure, decentralized and future-proof way. Join us in this Journey.</p>
                        <div className="flex justify-between items-center pb-2 border-b border-borderColor mb-4">
                            <input type="text" className="border-0 p-0 m-0 outline-none w-[calc(100%-160px)] bg-transparent" placeholder="White Hat DAO LLC" />
                ...
                <p className="lg:hidden block text-[12px] opacity-70 text-center">© 2024 ALL RIGHTS RESERVED BY WHITEHATDAO.COM</p>
            </ContainerBig>
        </div>
    )
}
