    ...
    <div className="rounded-xl bg-lighterColor py-3 px-5 mb-4">
      <div className="flex justify-between">
        <div className="flex items-center">
          <div className={clsx("w-[8px] h-[8px] mr-2 rounded-full", getColor(props.step))}></div>
      ...
      <div className="flex justify-between -mx-1">
        ...
        <button className="text-[13px] rounded-md font-primary py-0 bg-white text-black flex items-center" style={{padding: "4px 5px"}}><DownloadSvg className="mr-2 mt-[1px]" /> Investor CSV File</button>
      </div>
    </div>
  )
}
