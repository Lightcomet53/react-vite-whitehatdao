    ...
    return (
        <div className="relative">
            <nav className="sticky top-0 left-0 w-full flex justify-between items-center border-b border-borderColor bg-bgColor z-[9999]">
                <div className="w-[20vw] 2xl:w-[18vw] pl-[4.3vw] lg:pl-[2.2vw] flex items-center select-none">
                ...
                <div className="w-[60vw] 2xl:w-[64vw]">
                    ...
                    <div className="flex items-center border-x border-borderColor text-[13px] lg:text-[13px] xl:text-[14px] 2xl:text-[15px] lg-max:hidden">
                        <WHDFeatures />
                ...
                <div className="w-[20vw] 2xl:w-[18vw] flex justify-end pr-[4.3vw] lg:pr-[2.2vw]">
                    <ConnectWalletBtn />
                </div>
            </nav>
            {clicked && (<MobileView />)}
